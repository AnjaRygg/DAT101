...
function selectTask5AnimalsClick() {
  ...
  txtTask5Output.innerHTML = "You selected " + optionText;
}
text = "";
...
const txtMovieRating = document.getElementById("txtMovieRate");
const tblMovies = document.getElementById("tblMovies").querySelector("tbody");
...
document.getElementById("cmbAddMovie").addEventListener("click", function () {
  ...
  const rating = txtMovieRating.value.trim();
  ...
  cellNumber.textContent = movieCount; // Add the movie number
